...
export const mdxComponents: MDXComponents = {
  ...
  ul: (props) => (
    <ul className="my-4 list-disc space-y-2 pl-5 marker:text-ink-muted" {...props} />
  ),
  ol: (props) => (
    <ol className="my-4 list-decimal space-y-2 pl-5 marker:text-ink-muted" {...props} />
  ),
  blockquote: (props) => (
    <blockquote
      className="my-6 border-l border-indigo pl-4 text-ink-muted"
      {...props}
    />
  ),
  ...
  th: (props) => (
    <th
      className="border-b border-line py-2 pr-4 text-left text-cap font-mono tracking-frame uppercase font-normal text-ink-muted"
      {...props}
    />
  ),
